...
EXTRA_CFLAGS :=  -std=c++11 -DMAX_VERBOSE_LEVEL=8 -MMD


SRC :=  main.cpp lib/inih/ini.c lib/async/queue.cpp mqtt.cpp  $(wildcard lib/spaxstack/*.cpp)   $(wildcard lib/radio/*.cpp) \
